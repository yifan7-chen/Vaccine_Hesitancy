...
dateidx =   664:771; % 2020.1.23 - 2020.3.19 because of the lockdown
vacidx  =   259:366;
Bidx = 1:108;
...
% pars_phase_3.report_local = daily_local_report(:,2).Variables;
% pars_phase_3.report_local = movmean(pars_phase_3.report_local,[6 0]);
% pars_phase_3.report_local = pars_phase_3.report_local(dateidx);
% 
% pars_phase_3.report_death = daily_deceased(:,2).Variables;
% pars_phase_3.report_death = movmean(pars_phase_3.report_death,[6 0]);
% pars_phase_3.report_death = pars_phase_3.report_death(dateidx);
...
% Timeline
pars_phase_3.t0 = datetime(2021,11,10); 
pars_phase_3.tf = datetime(2022,02,26);
...
% pars_phase_3.e2f = [eye(4) eye(4)];
% pars_phase_3.h2f = [eye(4) eye(4) eye(4) eye(4)];
% pars_phase_3.f2e = [eye(4);eye(4)];
% pars_phase_3.f2h = [eye(4);eye(4);eye(4);eye(4)];
% pars_phase_3.e2h = [eye(8);eye(8)];
% pars_phase_3.e2e = pars_phase_3.f2e * pars_phase_3.e2f;
% pars_phase_3.CM2 = pars_phase_3.f2e * pars_phase_3.AllContacts;
% pars_phase_3.CM4 = pars_phase_3.f2h * pars_phase_3.AllContacts;
% pars_phase_3.resus2 = pars_phase_3.f2e * pars_phase_3.relative_susceptibility';
