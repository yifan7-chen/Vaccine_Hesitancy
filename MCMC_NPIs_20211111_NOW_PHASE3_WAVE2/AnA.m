...
% [t, Y, pars_out] = SEIRD_model_ThetaSweep(chainst(:,1), pars_phase_3.times, pars_phase_3);
[t, Y, pars_out] = SEIRD_model_ThetaSweep(median(chain_out)', pars_phase_3.times, pars_phase_3);
% [t1, Y1, pars_out1] = SEIRD_model_ThetaSweep(mean(chain_out)', pars_phase_3.times, pars_phase_3);
% [t1, Y1, pars_out1] = SEIRD_model_ThetaSweep([0.645259161	3.378457351	1.297992377	41.68667688	-4.8309	-5.594582847	506.5455257	447.194213	60.99800275	-3.51137395	23.35259803	-19.02357327	63.77605288	17.64136678]', pars_phase_3.times, pars_phase_3);
...
for j = 1:length(Comps)
    ...
    % 'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        hold on 
        plot(ts, diffIsym, 's', 'Color', '#6c5ce7', 'MarkerSize', 10, ...
    ...
    % 'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        hold on 
        plot(ts, diffB, 's', 'Color', '#6c5ce7', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
...
% [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_P]
