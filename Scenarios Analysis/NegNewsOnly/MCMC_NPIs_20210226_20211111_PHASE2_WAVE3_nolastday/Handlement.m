...
%Original
[t, Y, pars_out] = SEIRD_model_ThetaSweep(median(chain_out)', pars_phase_2.times, pars_phase_2);


diffIsym =  Calc_dI_dt(Y, Pars);
diffD =  Calc_dD_dt(Y, Pars);
diffV = Calc_dV1_dt(Y,Pars);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "I"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffIsym, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        infect_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.local_target_mov];
    ...
    elseif j_comp == "V1"    % Infected
        plot(ts, Pars.vac_count, 's', 'Color', '#d63031', 'MarkerSize', 10, ...
         'MarkerFaceColor','#d63031',    'DisplayName', 'Serology data')
        legend({'Reported cases(local symptomatic)'},'Location','northwest', 'fontsize', 18)
        legend boxoff
        yl=ylabel('Infected individuals','fontweight','bold');
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serologymedian data')
        V1_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
...
chain_out_75 = chain_out;


chain_out_75(:,7) = 0.75 .* chain_out_75(:,7);
chain_out_75(:,9) = 0.75 .* chain_out_75(:,9);
chain_out_75(:,8) = zeros(length(burnOut),1);
chain_out_75(:,10) = zeros(length(burnOut),1);
i_samp = randi([1, length(burnOut)], 1,NSamples);
chain_samp_75 = chain_out_75(i_samp,:);
[t_75, Y_75, pars_out_75] = SEIRD_model_ThetaSweep_all_initial(median(chain_out_75)', pars_phase_2.times, pars_phase_2,75);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_75, 's', 'Color', '#27ae60', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
        V1_75_CI =[mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
    xlim([Pars.t0, Pars.tf])
...
chain_out_50 = chain_out;


chain_out_50(:,7) = 0.50 .* chain_out_50(:,7);
chain_out_50(:,9) = 0.50 .* chain_out_50(:,9);
chain_out_50(:,8) = zeros(length(burnOut),1);
chain_out_50(:,10) = zeros(length(burnOut),1);
i_samp = randi([1, length(burnOut)], 1,NSamples);
chain_samp_50 = chain_out_50(i_samp,:);
[t_50, Y_50, pars_out_50] = SEIRD_model_ThetaSweep_all_initial(median(chain_out_50)', pars_phase_2.times, pars_phase_2,50);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_50, 's', 'Color', '#27ae60', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
        V1_50_CI =[mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
    xlim([Pars.t0, Pars.tf])
...
chain_out_25 = chain_out;


chain_out_25(:,7) = 0.25 .* chain_out_25(:,7);
chain_out_25(:,9) = 0.25 .* chain_out_25(:,9);
chain_out_25(:,8) = zeros(length(burnOut),1);
chain_out_25(:,10) = zeros(length(burnOut),1);
i_samp = randi([1, length(burnOut)], 1,NSamples);
chain_samp_25 = chain_out_25(i_samp,:);
[t_25, Y_25, pars_out_25] = SEIRD_model_ThetaSweep_all_initial(median(chain_out_25)', pars_phase_2.times, pars_phase_2,25);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_25, 's', 'Color', '#27ae60', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
        V1_25_CI =[mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
    xlim([Pars.t0, Pars.tf])
...
chain_out_85 = chain_out;


chain_out_85(:,7) = 0.85 .* chain_out_85(:,7);
chain_out_85(:,9) = 0.85 .* chain_out_85(:,9);
i_samp = randi([1, length(burnOut)], 1,NSamples);
chain_samp_85 = chain_out_85(i_samp,:);
[t_85, Y_85, pars_out_85] = SEIRD_model_ThetaSweep_all_initial(median(chain_out_85)', pars_phase_2.times, pars_phase_2,85);
diffIsym_85 =  Calc_dI_dt_all(Y_85, Pars,85);
diffD_85 =  Calc_dD_dt_all(Y_85, Pars,85);
diffV_85 = Calc_dV1_dt_all(Y_85,Pars,85);
...
for j = 1:length(Comps)
    ...
    % Sample the rest
    for i = 1:NSamples
        i_th = chain_samp_85(i,:);
        sampled_fits(i,:) = SEIRD_model_Theta_all(i_th, Pars.times, Pars, j_comp, true,85);
    end
    ...
    elseif j_comp == "I"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffIsym_85, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        infect_85_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.local_target_mov];
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_85, 's', 'Color', '#27ae60', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
        V1_85_CI =[mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
    xlim([Pars.t0, Pars.tf])
...
chain_out_90 = chain_out;


chain_out_90(:,7) = 0.90 .* chain_out_90(:,7);
chain_out_90(:,9) = 0.90 .* chain_out_90(:,9);
i_samp = randi([1, length(burnOut)], 1,NSamples);
chain_samp_90 = chain_out_90(i_samp,:);
[t_90, Y_90, pars_out_90] = SEIRD_model_ThetaSweep_all_initial(median(chain_out_90)', pars_phase_2.times, pars_phase_2,90);
diffIsym_90 =  Calc_dI_dt_all(Y_90, Pars,90);
diffD_90 =  Calc_dD_dt_all(Y_90, Pars,90);
diffV_90 = Calc_dV1_dt_all(Y_90,Pars,90);
...
for j = 1:length(Comps)
    ...
    % Sample the rest
    for i = 1:NSamples
        i_th = chain_samp_90(i,:);
        sampled_fits(i,:) = SEIRD_model_Theta_all(i_th, Pars.times, Pars, j_comp, true,90);
    end
    ...
    elseif j_comp == "I"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffIsym_90, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        infect_90_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.local_target_mov];
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_90, 's', 'Color', '#27ae60', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
        V1_90_CI =[mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
    xlim([Pars.t0, Pars.tf])
...
chain_out_95 = chain_out;


chain_out_95(:,7) = 0.95 .* chain_out_95(:,7);
chain_out_95(:,9) = 0.95 .* chain_out_95(:,9);
i_samp = randi([1, length(burnOut)], 1,NSamples);
chain_samp_95 = chain_out_95(i_samp,:);
[t_95, Y_95, pars_out_95] = SEIRD_model_ThetaSweep_all_initial(median(chain_out_95)', pars_phase_2.times, pars_phase_2,95);
diffIsym_95 =  Calc_dI_dt_all(Y_95, Pars,95);
diffD_95 =  Calc_dD_dt_all(Y_95, Pars,95);
diffV_95 = Calc_dV1_dt_all(Y_95,Pars,95);
...
for j = 1:length(Comps)
    ...
    % Sample the rest
    for i = 1:NSamples
        i_th = chain_samp_95(i,:);
        sampled_fits(i,:) = SEIRD_model_Theta_all(i_th, Pars.times, Pars, j_comp, true,95);
    end
    ...
    elseif j_comp == "I"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffIsym_95, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        infect_95_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.local_target_mov];
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_95, 's', 'Color', '#27ae60', 'MarkerSize', 10, ...
    'MarkerFaceColor','#6c5ce7', 'DisplayName', 'Serology data')
        V1_95_CI =[mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count];
    end
    ylim([0, Inf])
    xlim([Pars.t0, Pars.tf])
...
% mcmcplot(chain_out,[],Res,'acf',100);
[mean(chain_out)' median(chain_out)' min(chain_out)' max(chain_out)']
% [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.local_target_mov]
% [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count]
% MCMC_Generate_Figures(DATE, PHASE, PARAMETER_SET, LIKELIHOOD_TYPE, N_VARS, 1);
