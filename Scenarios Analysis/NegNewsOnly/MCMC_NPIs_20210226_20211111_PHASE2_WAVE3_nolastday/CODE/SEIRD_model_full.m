function dYdt = SEIRD_model_full(t, X, Pars)
   ...
   temp_Iv2_CM  =   temp_Iv2/infec2tot*CM;
    ...
    if t<15
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio) -81.89849047+ Pars.threshold_2vac); %+ Pars.npi_payoff
    elseif t>=15 && t<52
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio)-81.89849047+ Pars.threshold_2vac + Pars.threshold1_2vac); %+ Pars.npi_payoff
    elseif t>=52 && t<58
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio)-81.89849047+ Pars.threshold_2vac + Pars.threshold1_2vac + Pars.threshold2_2vac); %+ Pars.npi_payoff
    elseif t>=58 && t<Pars.center_vac
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio)-81.89849047+ Pars.threshold_2vac + Pars.threshold1_2vac + Pars.threshold2_2vac + Pars.threshold3_2vac); %+ Pars.npi_payoff
    else
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio) -81.89849047+ Pars.threshold_2vac + Pars.threshold1_2vac + Pars.threshold2_2vac + Pars.threshold3_2vac + Pars.threshold4_2vac); %+ Pars.npi_payoff
