function res = MCMC_find_optimal_parms_for_phase(DATE_IN, PHASE_IN, PARAMETER_SET_IN, LIKELIHOOD_TYPE_IN, N_VARS_IN, CHAIN_LENGTH, CHAIN_REP, N_CHAINS)
    ...
    params = {
        ...
        {'center_vac'                 88+96*rand(1),                88         184}
        {'kappa_npi_2vac',           log(100*rand(1)),    log(0.001),   log(100)}
        {'r_2vac',                       1000*rand(1),             1,       1000}
        {'threshold_2vac',             -100+300*rand(1),           -100,         200}
        {'threshold1_2vac',            -100+200*rand(1),           -100,         100}
        {'threshold2_2vac',            -100+200*rand(1),           -100,         100}
        {'threshold3_2vac',            -100+200*rand(1),           -100,         100}
        {'threshold4_2vac',            -100+200*rand(1),           -100,         100}        
        };
    ...
    ParBounds = [
        [  2    0.5  123   log(10)        50       1     1  1 1 1]; 
        [0.5    0.3  88   log(0.001)      1     -100   -100 -100 -100 -100];
        [  3      1   184  log(100)     1000      200    100 100 100 100]
        ];
