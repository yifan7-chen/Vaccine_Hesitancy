...
%Original
[t, Y, pars_out] = SEIRD_model_ThetaSweep(median(chain_out)', pars_phase_3.times, pars_phase_3);


diffIsym =  Calc_dI_dt(Y, Pars);
diffD =  Calc_dD_dt(Y, Pars);
diffV = Calc_dV1_dt(Y,Pars);
diffB = Calc_dB_dt(Y,Pars);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        plot(ts, Pars.vac_count_P, 's', 'Color', '#d63031', 'MarkerSize', 10, ...
         'MarkerFaceColor','#d63031',    'DisplayName', 'Serology data')
        legend({'Reported cases(local symptomatic)'},'Location','northwest', 'fontsize', 18)
        legend boxoff
        yl=ylabel('Infected individuals','fontweight','bold');
    ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serologymedian data')
        V1_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_P];
    ...
    elseif j_comp == "VB"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffB, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        VB_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_B];
...
[t_85, Y_85, pars_out_85] = SEIRD_model_ThetaSweep_all(median(chain_out)', pars_phase_3.times, pars_phase_3,85);
diffIsym_85 =  Calc_dI_dt_all(Y_85, Pars,85);
diffD_85=  Calc_dD_dt_all(Y_85, Pars,85);
diffV_85 = Calc_dV1_dt_all(Y_85,Pars,85);
diffB_85 = Calc_dB_dt_all(Y_85,Pars,85);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_85, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        V1_85_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_P];
    ...
    elseif j_comp == "VB"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffB_85, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')       
        VB_85_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_B];
...
[t_90, Y_90, pars_out_90] = SEIRD_model_ThetaSweep_all(median(chain_out)', pars_phase_3.times, pars_phase_3,90);
diffIsym_90 =  Calc_dI_dt_all(Y_90, Pars,90);
diffD_90=  Calc_dD_dt_all(Y_90, Pars,90);
diffV_90 = Calc_dV1_dt_all(Y_90,Pars,90);
diffB_90 = Calc_dB_dt_all(Y_90,Pars,90);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_90, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        V1_90_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_P];
    ...
    elseif j_comp == "VB"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffB_90, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')       
        VB_90_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_B];
...
[t_95, Y_95, pars_out_95] = SEIRD_model_ThetaSweep_all(median(chain_out)', pars_phase_3.times, pars_phase_3,95);
diffIsym_95 =  Calc_dI_dt_all(Y_95, Pars,95);
diffD_95=  Calc_dD_dt_all(Y_95, Pars,95);
diffV_95 = Calc_dV1_dt_all(Y_95,Pars,95);
diffB_95 = Calc_dB_dt_all(Y_95,Pars,95);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_95, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        V1_95_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_P];
    ...
    elseif j_comp == "VB"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffB_95, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')       
        VB_95_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_B];
...
% [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_B]
% MCMC_Generate_Figures(DATE, PHASE, PARAMETER_SET, LIKELIHOOD_TYPE, N_VARS, 1);
