function res = MCMC_find_optimal_parms_for_phase(DATE_IN, PHASE_IN, PARAMETER_SET_IN, LIKELIHOOD_TYPE_IN, N_VARS_IN, CHAIN_LENGTH, CHAIN_REP, N_CHAINS)
    ...
    data.ydata = [pars_in.local_target_mov, pars_in.deceased_target_mov, pars_in.vac_count_P, pars_in.vac_count_B]; 
    ...
    params = {
        {'alpha_rate'     0.3 + 0.7*rand(1),           0.3,           1}
        {'p_sp',                1+9*rand(1),             1,          10}
        {'p_sp_c',           0.5+2.5*rand(1),           0.5,           3}

        {'center1',           33+14*rand(1),             33,         47}


        {'kappa_2vac',           log(100*rand(1)),    log(0.001),   log(100)}
        {'kappa_2B',             log(100*rand(1)),    log(0.001),   log(100)}
        {'r_2vac',                       1000*rand(1),             1,       1000}
        {'r_2B',                         1000*rand(1),             1,       1000}
        {'threshold_2vac',             -100+300*rand(1),           -100,         200}

        {'threshold_2B',                -100+200*rand(1),            -100,         100}
        {'threshold1_2B',               -100+200*rand(1),           -100,         100}
    ...
    ParBounds = [
        [0.5 3   2          40         log(10)     log(10)   50   50    1   1 1  ]; 
        [0.3 1   0.5       33     log(0.001)  log(0.001)    1    1  -100 -100 -100 ];
        [1 10   3       47         log(100)    log(100) 1000 1000   200 100 100 ]
        ];
    ...
    for i_paramChainSetup = 1:N_CHAINS     
        ...
        for i_param=1:N_VARS_IN            
            ...
            temp_params{i_param}{2} = temp_params{i_param}{2}; % log-transform. 
        end
