function dYdt = SEIRD_model_full(t, X, Pars)
    ...
    % temp_I_CM_nx    =   temp_I/infec2tot*CM_nx;
    % temp_Iv2_CM_x   =   temp_Iv2/infec2tot*CM_x;
    ...
    elseif t>=15 && t<52
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio)+ Pars.threshold_2vac + Pars.threshold1_2vac); %+ Pars.npi_payoff
    elseif t>=52 && t<58
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio)+ Pars.threshold_2vac + Pars.threshold1_2vac + Pars.threshold2_2vac); %+ Pars.npi_payoff
    elseif t>=58 && t<Pars.center_vac
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio)+ Pars.threshold_2vac + Pars.threshold1_2vac + Pars.threshold2_2vac + Pars.threshold3_2vac); %+ Pars.npi_payoff
    else
        dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio) + Pars.threshold_2vac + Pars.threshold1_2vac + Pars.threshold2_2vac + Pars.threshold3_2vac + Pars.threshold4_2vac); %+ Pars.npi_payoff
