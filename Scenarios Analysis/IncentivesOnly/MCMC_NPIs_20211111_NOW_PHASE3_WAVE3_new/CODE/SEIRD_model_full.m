function dYdt = SEIRD_model_full(t, X, Pars)
  ...
  elseif t >= Pars.t_feb22_start && t < Pars.t_mar22_start
    ...
    dYdt(Pars.Y2vac_ids) = Pars.kappa_2vac * (1 - ratio_2vac) .* ratio_2vac.*(temp_I_CM - temp_Iv2_CM + Pars.r_2vac.*(Dratio - Dv2ratio) +43.69744606+ Pars.threshold_2vac); %+ Pars.npi_payoff
