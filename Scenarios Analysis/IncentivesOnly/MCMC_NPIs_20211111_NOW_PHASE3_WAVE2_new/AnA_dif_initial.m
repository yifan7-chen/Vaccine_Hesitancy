...
[t_notrust, Y_notrust, pars_out_notrust] = SEIRD_model_ThetaSweep_notrust(median(chain_out)', pars_phase_3.times, pars_phase_3);
...
diffB_notrust = Calc_dB_dt_notrust(Y_notrust,Pars);
...
for j = 1:length(Comps)
    ...
    elseif j_comp == "V1"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffV_notrust, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')
        V1_notrust_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_P];
    ...
    elseif j_comp == "VB"    % Infected
        ...
        set(yl,'Pos',[ylabel_xpos pos(2) pos(3)]);
        hold on 
        plot(ts, diffB_notrust, 's', 'Color', '#0984e3', 'MarkerSize', 10, ...
    'MarkerFaceColor','#0984e3', 'DisplayName', 'Serology data')       
        VB_notrust_CI = [mean_sampled_fits' ci_higher_sampled_fits' ci_lower_sampled_fits' Pars.vac_count_B];
