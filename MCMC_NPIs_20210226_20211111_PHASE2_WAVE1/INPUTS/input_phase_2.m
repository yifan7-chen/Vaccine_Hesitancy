...
dateidx = 406:431; % 2020.1.23 - 2020.3.19 because of the lockdown
vacidx  =  5:30;
...
% pars_phase_1.infect_target = daily_sym_target + daily_asym_target;
% pars_phase_1.infect_target_7mean = movmean(pars_phase_1.infect_target,7);
% pars_phase_1.deceased_target = daily_deceased_target;

% Timeline
pars_phase_2.t0 = datetime(2021,02,25); 
pars_phase_2.tf = datetime(2021,03,23);
...
pars_phase_2.e2f = [eye(4) eye(4)];
pars_phase_2.h2f = [eye(4) eye(4) eye(4) eye(4)];
pars_phase_2.f2e = [eye(4);eye(4)];
pars_phase_2.f2h = [eye(4);eye(4);eye(4);eye(4)];
pars_phase_2.e2h = [eye(8);eye(8)];
pars_phase_2.e2e = pars_phase_2.f2e * pars_phase_2.e2f;
pars_phase_2.CM2 = pars_phase_2.f2e * pars_phase_2.AllContacts;
pars_phase_2.CM4 = pars_phase_2.f2h * pars_phase_2.AllContacts;
pars_phase_2.resus2 = pars_phase_2.f2e * pars_phase_2.relative_susceptibility';
