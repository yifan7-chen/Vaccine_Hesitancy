function res = MCMC_find_optimal_parms_for_phase(DATE_IN, PHASE_IN, PARAMETER_SET_IN, LIKELIHOOD_TYPE_IN, N_VARS_IN, CHAIN_LENGTH, CHAIN_REP, N_CHAINS)
    ...
    %% Setup Data & Functions
        ...
        data.ydata = [pars_in.local_target_mov,pars_in.deceased_target_mov]; 
        ssfun = @(Theta_in, Data_in) -2*SEIRD_model_LL_logTheta(Data_in.xdata, Data_in.ydata, Theta_in, pars_in); % technically is llfun
