...
% Population
model_pars.N = 7413070;   %https://www.census2021.gov.hk/tc/census_results.html

% Indices
N = 1;

model_pars.compartments = ["S",     "E",    "P",    "I",    "CT",   "R",    "D"];
model_pars.nCompartments = length(model_pars.compartments); 
...
initial_states = [7413070 0 1  0 0 0 0];
